...
2.  **Compresión Multibanda:** Controlar levemente el rango de los 250-500Hz
    para evitar que la mezcla suene "ajonjolada" (boxy) durante los estribillos
    más densos.
3.  **Excitatión Armónica:** Un toque de saturación de cinta (Tape Saturation)
    en el Master Bus aportaría una cohesión (glue) analógica muy necesaria.
4.  **Estéreo Width:** Automatizar el ancho estéreo para que en los coros se
    abra un 5-10% adicional respecto a los versos.
...
4.  **Fase 4 (Validación):** Realizar un "Car Test" y una escucha en
    dispositivos móviles para verificar la traslación de la mezcla.
