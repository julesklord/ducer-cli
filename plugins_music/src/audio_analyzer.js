...
export class AudioAnalyzer {
     ...
     */
    async visualize(audioPath, options = {}) {
        ...
        try {
            ...
            throw new Error(`Songsee error: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
    ...
    async transcribe(audioPath, options = {}) {
        ...
        try {
            ...
            throw new Error(`Whisper error: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
}
//# sourceMappingURL=audio_analyzer.js.map