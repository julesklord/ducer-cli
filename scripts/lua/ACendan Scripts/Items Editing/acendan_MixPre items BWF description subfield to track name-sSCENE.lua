-- @description Sound Devices MixPre Metadata Tools - Track Name
-- @author Aaron Cendan
-- @version 1.3
-- @metapackage
-- @provides
--   [main] . > acendan_MixPre items BWF description subfield to track name-sTAKE.lua
--   [main] . > acendan_MixPre items BWF description subfield to track name-sSCENE.lua
--   [main] . > acendan_MixPre items BWF description subfield to track name-sFILENAME.lua
--   [main] . > acendan_MixPre items BWF description subfield to track name-sTAPE.lua
--   [main] . > acendan_MixPre items BWF description subfield to track name-sNOTE.lua
    ...
    for i=0, num_sel_items - 1 do
      ...
      if take ~= nil then 
        ...
        if ret then
          ...
          local ret2, new_name = reaper.GetSetMediaTrackInfo_String( track, "P_NAME", bwf_field_contents, true )
        end
      end
    end
  else
