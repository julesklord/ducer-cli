-- @description Set last touched track or take FX (inside Container) output channel pin mappings to stereo channels (User Input)
-- @author Suzuki
-- @license GPL v3
-- @version 1.0
...
r.Undo_EndBlock("Set last touched FX output channel pin mappings to stereo", -1)