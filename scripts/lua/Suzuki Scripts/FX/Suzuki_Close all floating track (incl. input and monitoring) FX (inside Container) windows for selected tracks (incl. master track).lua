-- @description Close all floating track (incl. input and monitoring) FX (inside Container) windows for selected tracks (incl. master track)
-- @author Suzuki
-- @license GPL v3
-- @version 1.0
...
function Main()
  ...
  r.Undo_EndBlock('Close all floating track (incl. input and monitoring) FX (inside Container) windows for selected tracks (incl. master track)', 2)
end
