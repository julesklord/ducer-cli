sTitle = 'ReArtist theme adjuster'
reaper.ClearConsole()
...
if reaper.LocalizeString ~= nil then
  translate = function(s) return reaper.LocalizeString(s or '---',"ReArtist_Theme_Adjuster") end
else
...
function loadImage(idx, name)
  local str = debug.getinfo(1, "S").source:match[[^@(.*[\/])[^\/]-$]].."ReArtist_theme_adjuster_images/"
