-- Name: Lower 3 dB volume down for selected items
-- Date: 30-10-2023
-- Author: Bing Chat
...
function main()
    ...
    for i = 0, count - 1 do
        ...
        -- Convert volume from amplitude to dB, subtract 3 dB, and convert back to amplitude
        local newVol = 10 ^ ((20 * math.log(vol, 10) - 3) / 20)
