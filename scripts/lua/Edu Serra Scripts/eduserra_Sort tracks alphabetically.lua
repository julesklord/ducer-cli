...
if selNum == 0 then
  -- Display a popup window with an error message
  reaper.ShowMessageBox("There are no tracks selected. Select the tracks you want to sort and run the action again.", "Error", 0)
else
