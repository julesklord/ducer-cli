--[[
Description: Mute selected notes outside the current scale
Version: 1.0
Author: Lokasenna
...
About:
	Compares all selected MIDI notes with the current key + scale, muting any that aren't "legal".
--]]
...
reaper.Undo_EndBlock("Mute selected notes outside the current scale", -1)