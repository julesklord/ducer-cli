--[[
Description: Delete all notes outside the current scale
Version: 1.0
Author: Lokasenna
...
About:
	Compares all MIDI notes in the active take with the current key + scale, deleting any that aren't "legal".
--]]
...
reaper.Undo_EndBlock("Delete all notes outside the current scale", -1)