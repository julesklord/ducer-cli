...
* ReaScript Name: BuyOne_Add notes at pitch cursor to selection.lua
...
* Notes: In combination with the native actions 'Navigate: Select next/previous note' and 'Navigate: Move edit cursor to start of selected events' can be used to set pitch cursor to next/previous note
