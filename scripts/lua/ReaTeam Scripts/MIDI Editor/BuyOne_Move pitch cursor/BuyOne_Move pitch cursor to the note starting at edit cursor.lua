...
* ReaScript Name: BuyOne_Move pitch cursor to the note starting at edit cursor.lua
...
* Notes: 
-- If start times of several notes are identical like in a chord for example, pitch cursor moves to the highest note
-- In combination with the native actions 'Navigate: Select next/previous note' and 'Navigate: Move edit cursor to start of selected events' can be used to set pitch cursor to next/previous note
