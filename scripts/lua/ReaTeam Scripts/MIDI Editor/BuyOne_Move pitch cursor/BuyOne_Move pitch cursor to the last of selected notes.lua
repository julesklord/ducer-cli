...
* ReaScript Name: BuyOne_Move pitch cursor to the last of selected notes.lua
...
* Notes: If start times of several notes are identical like in a chord for example, the last one is the lowest, otherwise it's the one having the latest start time
