...
1.  [Create a service account and key](https://cloud.google.com/iam./keys-create-delete)
...
1.  Obtain a Google Cloud API key:
    [Get an API Key](https://cloud.google.com/vertex-ai/generative-ai./start/api-keys?usertype=newuser).
...
2.  [Enable the Gemini for Cloud API](https://cloud.google.com/gemini./discover/set-up-gemini#enable-api).

3.  [Configure necessary IAM access permissions](https://cloud.google.com/gemini./discover/set-up-gemini#grant-iam).
